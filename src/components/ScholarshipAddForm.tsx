  ...
  constructor(props: any) {
    ...
    render(){
      ...
      return (
        ...
        <input value={scholarship.description} name="funding amount" onChange={this.onUpdateScholarship} id="scholarshipFundingAmountInput" className="form-control mb-3" placeholder="Funding Amount" type="number"></input>
